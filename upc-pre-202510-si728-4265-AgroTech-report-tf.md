...
<img src="resources/UPCPng.png" width="50%" style="display: block; margin: auto;" />
...
|Duración entrevista: 00:00-05:39 |[Link de la Entrevista](https://acortar.link/12xr5k)
|
...
|Duración entrevista: 05:39 - 14:48     |[Link de la Entrevista](https://acortar.link/12xr5k)|
...
|Duración entrevista:  14:48 - 30:31  |[Link de la Entrevista](https://acortar.link/12xr5k)|
...
|Duración entrevista: 30:31-36:12 |[Link de la Entrevista](https://acortar.link/12xr5k)|
...
|Duración entrevista: 36:12 - 43:35 |[Link de la Entrevista](https://acortar.link/12xr5k)|
...
|Duración entrevista: 43:35 - 49:11    |[Link de la Entrevista](https://acortar.link/12xr5k)|
...
<img src="resources/CAPITULO5/monitoreoiot.png">
...
<img src="resources/CAPITULO5/riego.png">
...
Entre las evidencias de ejecución se encuentra tanto el desarrollo del 100% de los endpoints necesarios de la solución así como las pruebas unitarias de la lógica de ciertas secciones, principalmente de los cultivos y IoT divices, y tambien el desarrollo completo de nuestro fronted.

Backend:

<img src = "resources\execution1.png">

<img src = "resources\execution2.png">

Fronted:

<img src = "resources\execution3.png">
...
| :-------------- | :---------- | :-------------------------------------- | :----------------- |
| **Cultivos**    | `POST`      | `/api/v1/cultivos`                      | N/A                |
| **Cultivos**    | `GET`       | `/api/v1/cultivos`                      | N/A                |
| **Cultivos**    | `GET`       | `/api/v1/cultivos/{cultivoId}`          | `{cultivoId}`      |
| **Cultivos**    | `PUT`       | `/api/v1/cultivos/{cultivoId}`          | `{cultivoId}`      |
| **Cultivos**    | `DELETE`    | `/api/v1/cultivos/{cultivoId}`          | `{cultivoId}`      |
| **Sensores**    | `POST`      | `/api/v1/sensores/lecturas`             | N/A                |
| **Sensores**    | `GET`       | `/api/v1/sensores/historial`            | N/A                |
| **Sensores**    | `GET`       | `/api/v1/sensores/dashboard`            | N/A                |
| **Anomalías**   | `POST`      | `/api/v1/anomalias`                     | N/A                |
| **Anomalías**   | `GET`       | `/api/v1/anomalias`                     | N/A                |
| **Anomalías**   | `GET`       | `/api/v1/anomalias/{anomaliaId}`        | `{anomaliaId}`     |
| **Anomalías**   | `GET`       | `/api/v1/anomalias/cultivo/{cultivoId}` | `{cultivoId}`      |

<div id='7.2.1.7.'><h4>7.2.1.7. Software Deployment Evidence for Sprint Review</h4></div>

Como parte del despliegue de nuestra solución, por ahora el sistema IOT muestra datos de los sensores y los envia al backend directamente donde los mostrara en el fronted como datos reales. 

Iot:

<img src = "resources\execution5.png">

Backend:

<img src = "resources\execution6.png">


<div id='7.2.1.8.'><h4>7.2.1.8. Team Collaboration Insights during Sprint</h4></div>

En base al desarrollo que se percibió del equipo, consideramos que todo el equipo trabajó de forma equitativa y de forma satisfactoria para el desarrollo de este sprint, como se mencionó nuestro objetivo de este sprint, fue la implementación del desarrollo backend, fronted y nuestro sistema IOT. Si bien no todos pudieron aportar en el apartado técnico por situaciones personales, apoyaron para la investigación.

Fronted:

<img src = "resources\fronted.png">
...
|Nombre entrevistado| Rodrigo Pisconti Palacios |
|-|-|
|Edad|24 años|
|Departamento|Lima, Lima|
...
* **TP:** En esta etapa del proyecto se consolidó la propuesta inicial mediante el desarrollo visual de la solución, elaborando los mockups de la aplicación web que permitieron materializar la experiencia del usuario esperada. Este entregable representó un avance significativo, ya que se definieron con mayor claridad las interfaces clave para los agricultores, así como la navegación lógica del sistema. El diseño se realizó en base a las entrevistas y necesidades previamente identificadas, priorizando la usabilidad, el acceso rápido a datos críticos (como humedad o calidad del suelo) y la simplicidad en la interacción. Esta entrega permitió validar con usuarios potenciales si la propuesta era visualmente funcional, asegurando que los elementos planteados respondan adecuadamente a sus contextos de uso. En conjunto, el TP representó la transición del análisis conceptual a una representación visual tangible de la solución TomateRitmo.
...
**Carpeta con todos los videos:** [Recopilación videos](https://upcedupe-my.sharepoint.com/:f:/g/personal/u202124343_upc_edu_pe/EnFZtnWMrfRJhvz2icrnOnABOHz1BB7m-BjsSiXmxQP0Og?e=lhOewy)
